package day.lone.mail.plugin.inventory;
...
public class GuiMailBox extends CustomInventoryHolder {
    ...
    public GuiMailBox(OfflinePlayer player) {
    ...
    private ItemStack getPresent(ItemStack itemStack) {
        return ItemUtils.setItemStack(itemStack.clone())
                .setLore(List.of("&a[ 클릭 시 해당 아이템을 지급 받습니다. ]")).getItemStack();
    }
